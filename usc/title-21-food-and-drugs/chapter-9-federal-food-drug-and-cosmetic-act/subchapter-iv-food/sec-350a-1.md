...
(5) the date each new infant formula described in subparagraph (A) <sup><a href="#350a-1_1_target" name="350a-1_1">1</a></sup> was first marketed, if available.
...
[<sup>1</sup> So in original. There is no subparagraph (A).](#350a-1_1)