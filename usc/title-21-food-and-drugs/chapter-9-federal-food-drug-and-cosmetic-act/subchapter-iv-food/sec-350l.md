### §350*l*. Mandatory recall authority ###
...
(ii) to which such article has been distributed, transported, or sold, to immediately cease distribution of such article.<sup><a href="#350l_1_target" name="350l_1">1</a></sup>
...
(3) if available, publish on the Internet Web site of the Food and Drug Administration an image of the article that is the subject of the press release described in (1).<sup><a href="#350l_2_target" name="350l_2">2</a></sup>
...
[<sup>1</sup> So in original. The words "to immediately cease distribution of such article." probably should follow cl. (ii).](#350l_1)

[<sup>2</sup> So in original. Probably should be "paragraph (1)."](#350l_2)