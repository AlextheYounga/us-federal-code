...
(II) the date of a decision of a court in an action described in subclause (III) <sup><a href="#360b_3_target" name="360b_3">3</a></sup> holding the patent which is the subject of the certification to be invalid or not infringed,
...
[<sup>1</sup> See References in Text note below.](#360b_1)

[<sup>2</sup> So in original. Probably should be "Alimentarius".](#360b_2)

[<sup>3</sup> So in original. Probably should be "clause (iii)(III)".](#360b_3)