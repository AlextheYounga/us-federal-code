...
Subject to clause (iv),<sup><a href="#1532_1_target" name="1532_1">1</a></sup> the Administrator may award a renewal grant to a grant recipient under this subparagraph <sup><a href="#1532_2_target" name="1532_2">2</a></sup> for each fiscal year of the 4-fiscal-year period following the first fiscal year for which the initial additional grant is awarded in an amount not to exceed the following:
...
[<sup>1</sup> So in original. Probably should be "subparagraph (F),".](#1532_1)

[<sup>2</sup> So in original. Probably should be "this paragraph".](#1532_2)