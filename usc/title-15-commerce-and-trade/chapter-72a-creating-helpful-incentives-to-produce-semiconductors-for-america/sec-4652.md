...
(i) the covered entity has a documented interest in constructing, expanding, or modernizing a facility described in paragraph (1) <sup><a href="#4652_1_target" name="4652_1">1</a></sup>
...
(iii) aggregated workforce data, including data by race or ethnicity, sex, and job categories.<sup><a href="#4652_2_target" name="4652_2">2</a></sup>
...
The loan agreement for a loan guaranteed under this subsection shall provide that no provision of the loan agreement may be amended of <sup><a href="#4652_3_target" name="4652_3">3</a></sup> waived without the consent of the Secretary.
...
[<sup>1</sup> So in original. Probably should be followed by a semicolon.](#4652_1)

[<sup>2</sup> So in original. The period probably should be "; and".](#4652_2)

[<sup>3</sup> So in original. Probably should be "or".](#4652_3)