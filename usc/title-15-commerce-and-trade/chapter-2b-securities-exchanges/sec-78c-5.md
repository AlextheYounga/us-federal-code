...
A broker, dealer, or security-based swap dealer shall treat and deal with all money, securities, and property of any security-based swaps customer received to margin, guarantee, or secure a security-based swap cleared by or though <sup><a href="#78c-5_1_target" name="78c-5_1">1</a></sup> a clearing agency (including money, securities, or property accruing to the security-based swaps customer as the result of such a security-based swap) as belonging to the security-based swaps customer.
...
[<sup>1</sup> So in original. Probably should be “through”.](#78c-5_1)

[<sup>2</sup> So in original.](#78c-5_2)