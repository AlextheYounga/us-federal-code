...
In the event of a transaction which involves both an unauthorized electronic fund transfer and an extension of credit as defined in section 1602(e) <sup><a href="#1693g_2_target" name="1693g_2">2</a></sup> of this title pursuant to an agreement between the consumer and the financial institution to extend such credit to the consumer in the event the consumer's account is overdrawn, the limitation on the consumer's liability for such transaction shall be determined solely in accordance with this section.
...
[<sup>1</sup> So in original. Probably should be “means”.](#1693g_1)

[<sup>2</sup> See References in Text note below.](#1693g_2)