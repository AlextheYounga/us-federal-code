...
(B) in the case of a transaction, other than a mortgage referred to in section 1602(aa) <sup><a href="#1605_1_target" name="1605_1">1</a></sup> of this title, which—

(i) is a refinancing of the principal balance then due and any accrued and unpaid finance charges of a residential mortgage transaction as defined in section 1602(w) <sup><a href="#1605_1_target" name="1605_1">1</a></sup> of this title, or is any subsequent refinancing of such a transaction; and
...
[<sup>1</sup> See References in Text note below.](#1605_1)