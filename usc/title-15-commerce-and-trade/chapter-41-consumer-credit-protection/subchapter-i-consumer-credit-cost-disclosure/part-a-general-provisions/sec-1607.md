...
(B) the <sup><a href="#1607_1_target" name="1607_1">1</a></sup> amount of the adjustment would be less than $1, except that if more than one year has elapsed since the date of the violation, the agency may require that such amount be paid into the Treasury of the United States, or
...
[<sup>1</sup> So in original. Probably should be preceded by "if".](#1607_1)