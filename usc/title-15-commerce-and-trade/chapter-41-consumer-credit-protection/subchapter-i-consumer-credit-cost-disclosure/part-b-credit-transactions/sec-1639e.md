...
In connection with a consumer credit transaction secured by a consumer's principal dwelling, a creditor who knows, at or before loan consummation, of a violation of the appraisal independence standards established in subsections <sup><a href="#1639e_1_target" name="1639e_1">1</a></sup> (b) or (d) shall not extend credit based on such appraisal unless the creditor documents that the creditor has acted with reasonable diligence to determine that the appraisal does not materially misstate or misrepresent the value of such dwelling.
...
[<sup>1</sup> So in original. Probably should be "subsection".](#1639e_1)