...
(A) paragraph (1) or (3) of section 77d <sup><a href="#77r_1_target" name="77r_1">1</a></sup> of this title, and the issuer of such security files reports with the Commission pursuant to section 78m or 78o(d) of this title;

(B) section 77d(4) <sup><a href="#77r_1_target" name="77r_1">1</a></sup> of this title;
...
[<sup>2</sup> So in original. The comma after "enforcement actions" probably should be a hyphen and the words "in connection with securities or securities transactions" probably should be part of subpar. (A).](#77r_2)
