...
All employers that are treated as a single employer under subsection (b) or (c) of section 414 of title 26 shall be treated as a single employer for purposes of determining if a plan was maintained by more than one employer under subparagraph <sup><a href="#1060_2_target" name="1060_2">2</a></sup> (B) and (C) of paragraph (1).
...
[<sup>2</sup> So in original. Probably should be "subparagraphs".](#1060_2)