...
(iv) such items and services were furnished during the 30 day <sup><a href="#1185e_2_target" name="1185e_2">2</a></sup> period following the date on which the first item or service included with respect to such determination was furnished or an alternative period as determined by the Secretary, for use in limited situations, such as by the consent of the parties or in the case of low-volume items and services, to encourage procedural efficiency and minimize health plan and provider administrative costs.
...
Each party to a determination under paragraph (5) to which an entity is selected under paragraph (3) <sup><a href="#1185e_3_target" name="1185e_3">3</a></sup> in a year shall pay to the Secretary, at such time and in such manner as specified by the Secretary, a fee for participating in the IDR process with respect to such determination in an amount described in subparagraph (B) for such year.
...
[<sup>2</sup> So in original. Probably should be "30-day".](#1185e_2)

[<sup>3</sup> So in original. Probably should be "paragraph (4)".](#1185e_3)

[<sup>4</sup> So in original. Probably should be followed by a period.](#1185e_4)