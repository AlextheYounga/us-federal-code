...
For local areas in a State that are not covered by paragraph (1)(A)(i)(I), an entity administering a program funded with direct spending as defined in section 900(c)(8) of title 2, as in effect on February 15, 2014 <sup><a href="#3151_2_target" name="3151_2">2</a></sup> shall not be required to provide, for purposes of this paragraph, an amount in excess of the amount determined under subparagraph (C)(i) to be equivalent to the cost of the proportionate use of the one-stop centers for the one-stop partner for such program in the State.
...
[<sup>2</sup> So in original. Probably should be "2014,".](#3151_2)