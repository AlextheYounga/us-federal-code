...
"(7) Undefinitized contract action.—The term 'undefinitized contract action' means any contract action for which the contract terms, specifications, or price is not established prior to the start of the performance of the covered contract award.
...
[<sup>1</sup> So in original. Probably should be "Office for State and Local Government Coordination".](#112_1)