...
#### (A) Partnerships permitted to be required to file on magnetic media ####

In the case of a partnership, paragraph (2)(A) shall be applied by substituting for "250" the following amount:
...
Notwithstanding subparagraph (A) and paragraph (2)(A), the Secretary shall require partnerships having more than 100 partners to file returns on magnetic media.
