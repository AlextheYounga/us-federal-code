...
Except as otherwise provided in this section, in the case of any underpayment of estimated tax by an individual, there shall be added to the tax under chapter 1 <sup><a href="#6654_1_target" name="6654_1">1</a></sup> the tax under chapter 2, and the tax under chapter 2A for the taxable year an amount determined by applying—
...
| **In the case of the following<br/><br/> required installments:**|          **The due date is:**           |
|------------------------------------------------------------------|-----------------------------------------|
|                                1st                               |                April 15                 |
|                                2nd                               |                 June 15                 |
|                                3rd                               |              September 15               |
...
| **If the preceding taxable year<br/><br/> begins in:**|**The applicable percentage is:**|
|-------------------------------------------------------|---------------------------------|
|                         1998                          |               105               |
|                         1999                          |              108.6              |
|                         2000                          |               110               |
...
| **In the case of the following<br/><br/> required installments:**|**The applicable percentage is:**|
|------------------------------------------------------------------|---------------------------------|
|                               1st                                |              22.5               |
|                               2nd                                |               45                |
|                               3rd                                |              67.5               |
...
[<sup>1</sup> So in original. A comma probably should appear.](#6654_1)