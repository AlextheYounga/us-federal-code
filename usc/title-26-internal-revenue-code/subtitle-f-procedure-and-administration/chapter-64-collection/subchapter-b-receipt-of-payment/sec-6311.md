...
(D) the term "creditor" under section 103(f) <sup><a href="#6311_1_target" name="6311_1">1</a></sup> of the Truth in Lending Act (15 U.S.C. 1602(f)) shall not include the Secretary with respect to credit card transactions in payment of internal revenue taxes (or payment for internal revenue stamps), and
...
[<sup>1</sup> See References in Text note below.](#6311_1)