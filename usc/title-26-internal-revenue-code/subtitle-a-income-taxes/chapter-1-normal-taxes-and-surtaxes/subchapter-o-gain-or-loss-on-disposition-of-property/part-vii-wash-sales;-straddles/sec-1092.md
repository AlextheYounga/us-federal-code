...
A straddle shall be treated as clearly identified for purposes of clause (i) only if such identification includes an identification of the positions in the straddle which are offsetting with respect <sup><a href="#1092_1_target" name="1092_1">1</a></sup> other positions in the straddle.
...
For purposes of the preceding sentence, the rules of paragraphs (3) (other than subparagraph (B) <sup><a href="#1092_2_target" name="1092_2">2</a></sup> thereof) and (4) of section 246(c) shall apply in determining the period for which the taxpayer holds the stock.
...
[<sup>1</sup> So in original. Probably should be followed by "to".](#1092_1)
