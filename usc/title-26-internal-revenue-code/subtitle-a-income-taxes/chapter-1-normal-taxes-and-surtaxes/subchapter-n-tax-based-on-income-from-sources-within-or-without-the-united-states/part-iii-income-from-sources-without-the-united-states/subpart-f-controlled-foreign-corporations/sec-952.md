...
 In determining the deficit attributable to qualified activities described in subclause (II) or (III) of clause (iii),<sup><a href="#952_1_target" name="952_1">1</a></sup> deficits in earnings and profits (to the extent not previously taken into account under this section) for taxable years beginning after 1962 and before 1987 also shall be taken into account. In the case of the qualified activity described in clause (iii)(I),<sup><a href="#952_1_target" name="952_1">1</a></sup> the rule of the preceding sentence shall apply, except that "1982" shall be substituted for "1962".
...
[<sup>1</sup> See References in Text note below.](#952_1)