...
Subject to clause (ii), at the option of the State agency, allotments for residents of any facility described in subparagraph (B), (C), (D), or (E) of section 2012(n)(5) <sup><a href="#2017_1_target" name="2017_1">1</a></sup> of this title (referred to in this subsection as a "covered facility") may be determined and issued under this paragraph in lieu of subsection (a).
