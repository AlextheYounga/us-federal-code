...
(i) utilize the same metrics used to define the minimum acceptable level of broadband service under paragraph (1); <sup><a href="#950bb_1_target" name="950bb_1">1</a></sup>
...
[<sup>1</sup> So in original. Probably should be followed by "and".](#950bb_1)