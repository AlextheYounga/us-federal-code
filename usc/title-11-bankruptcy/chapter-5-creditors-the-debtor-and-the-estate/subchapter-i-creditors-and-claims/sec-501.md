...
(B) the term "eligible creditor" means a servicer (as defined in section 6(i) of the Real Estate Settlement Procedures Act of 1974 (12 U.S.C. 2605(i)) <sup><a href="#501_1_target" name="501_1">1</a></sup> with a claim for a Federally backed mortgage loan or a Federally backed multifamily mortgage loan of the debtor that is provided for by a plan under section 1322(b)(5);
...
[<sup>1</sup> So in original. Probably should be followed by another closing parenthesis.](#501_1)