...
(C) <sup><a href="#1902_1_target" name="1902_1">1</a></sup> Subject to subparagraph (D), the obligation to reimburse the United States under an agreement under subparagraph (A) is for all purposes a debt owing the United States.
...
[<sup>1</sup> So in original. No subpar. (B) has been enacted.](#1902_1)