...
(B) an explanation of why an extension is necessary for the orderly implementation of this title; <sup><a href="#5582_1_target" name="5582_1">1</a></sup> and

(C) a description of the steps that will be taken to effect an orderly and timely implementation of this title <sup><a href="#5582_1_target" name="5582_1">1</a></sup> within the extended time period.
