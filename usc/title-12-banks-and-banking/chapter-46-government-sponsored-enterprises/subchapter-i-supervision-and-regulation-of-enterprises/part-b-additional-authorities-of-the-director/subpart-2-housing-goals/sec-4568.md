...
(v) The resulting sum calculated from the factors described in clauses (i) through (iv) shall be multiplied by the relative cost of construction in the State. For purposes of this subclause,<sup><a href="#4568_1_target" name="4568_1">1</a></sup> the term “cost of construction”—
...
Not later than 60 days after the date that the Secretary determines the formula amounts described in paragraph (3), the Secretary shall caused <sup><a href="#4568_2_target" name="4568_2">2</a></sup> to be published in the Federal Register a notice that such amounts shall be so available.
...
(II) the <sup><a href="#4568_4_target" name="4568_4">4</a></sup> manner in which the State or State designated entity complied during such year with any allocation plan established pursuant to subsection (c).
...
[<sup>1</sup> So in original. Probably should be “this clause,”.](#4568_1)

[<sup>2</sup> So in original. Probably should be “cause”.](#4568_2)

[<sup>3</sup> See References in Text note below.](#4568_3)

[<sup>4</sup> So in original. A word appears to be missing before “the”.](#4568_4)