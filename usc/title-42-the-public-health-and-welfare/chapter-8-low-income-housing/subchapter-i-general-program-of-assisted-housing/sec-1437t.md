...
A public housing agency may convert a public housing project (or portion thereof) owned by the agency to tenant-based assistance only pursuant to a conversion assessment under subsection (b) that one year <sup><a href="#1437t_1_target" name="1437t_1">1</a></sup> and that demonstrates that the conversion—
...
[<sup>1</sup> So in original.](#1437t_1)