...
The Secretary may approve jurisdictions for participation in the demonstration program under this subchapter, but only from among applications that the Secretary has determined under paragraph <sup><a href="#1437bbb-5_2_target" name="1437bbb-5_2">2</a></sup> are approvable under this subchapter and only in accordance with section 1437bbb–1(c) of this title. The Secretary shall base the selection of jurisdictions to approve on the potential success, as evidenced by the application, in—
