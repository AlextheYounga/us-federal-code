...
(2) The Secretary may issue such a final order only with respect to a powerplant which is not, at the time the proposed order is issued, covered by a final rule issued under section (b) <sup><a href="#8343_1_target" name="8343_1">1</a></sup>.
...
[<sup>1</sup> So in original. Probably should be "subsection".](#8343_1)