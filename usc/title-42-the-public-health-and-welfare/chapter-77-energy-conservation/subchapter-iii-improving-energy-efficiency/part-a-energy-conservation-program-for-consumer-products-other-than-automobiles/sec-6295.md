...
(I) Using an Airflow Constant (Q<sub>0</sub>) of 26,500 cubic feet per minute.

(II) Using a Pressure Constant (P<sub>0</sub>) of 0.0027 inches water gauge.

(III) Using a Fan Efficiency Constant (η<sub>0</sub>) of 42 percent.
