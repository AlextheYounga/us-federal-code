...
If no amounts are set aside under, or amounts are precluded from being appropriated for this section for fiscal years after fiscal year 1983, any amount which is or becomes available for use under this section after fiscal year 1983 shall be added to amounts appropriated under section 5303 of this title, except that amounts available to the Secretary for use under this subsection as of October 1, 1993, and amounts released to the Secretary pursuant to subsection (t) may be used to provide grants under section 5308(q) of this title..<sup><a href="#5318_2_target" name="5318_2">2</a></sup>
