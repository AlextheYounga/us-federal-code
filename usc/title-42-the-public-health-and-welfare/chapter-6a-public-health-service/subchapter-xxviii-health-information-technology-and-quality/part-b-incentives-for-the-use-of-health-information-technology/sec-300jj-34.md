...
In determining the amount of non-Federal contributions that an eligible entity has provided pursuant to subparagraph (A),<sup><a href="#300jj-34_2_target" name="300jj-34_2">2</a></sup> the National Coordinator may not include any amounts provided to the entity by the Federal Government.
...
[<sup>1</sup> So in original. The word "and" probably should appear at end of subpar. (D).](#300jj-34_1)

[<sup>2</sup> So in original. Probably means "paragraph (1),".](#300jj-34_2)