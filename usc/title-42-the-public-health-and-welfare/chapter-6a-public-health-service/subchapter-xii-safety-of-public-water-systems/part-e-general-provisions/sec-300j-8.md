...
(3) for the collection of a penalty by the United States Government (and associated costs and interest) against any Federal agency that fails, by the date that is 18 months after the effective date of a final order to pay a penalty assessed by the Administrator under section 300h–8(b) <sup><a href="#300j-8_1_target" name="300j-8_1">1</a></sup> of this title, to pay the penalty.
...
[<sup>1</sup> So in original. Probably should be section "300j–6(b)".](#300j-8_1)