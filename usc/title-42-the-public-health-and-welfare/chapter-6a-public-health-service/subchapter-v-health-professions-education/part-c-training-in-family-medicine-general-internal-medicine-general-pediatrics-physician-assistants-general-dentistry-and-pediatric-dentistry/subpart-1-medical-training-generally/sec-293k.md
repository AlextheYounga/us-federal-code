...
(A) proposes <sup><a href="#293k_1_target" name="293k_1">1</a></sup> a collaborative project between academic administrative units of primary care;

(B) proposes <sup><a href="#293k_1_target" name="293k_1">1</a></sup> innovative approaches to clinical teaching using models of primary care, such as the patient centered medical home, team management of chronic disease, and interprofessional integrated models of health care that incorporate transitions in health care settings and integration physical and mental health provision;
...
[<sup>1</sup> So in original. Probably should be "propose".](#293k_1)