...
The Secretary shall limit the funding of full-time equivalent residents in order to ensure the direct and indirect payments as determined under subsection <sup><a href="#256h_1_target" name="256h_1">1</a></sup> (c) and (d) do not exceed the total amount of funds appropriated in a fiscal year under subsection (g).
...
[<sup>1</sup> So in original. Probably should be "subsections".](#256h_1)

[<sup>2</sup> See References in Text note below.](#256h_2)

[<sup>3</sup> So in original.](#256h_3)