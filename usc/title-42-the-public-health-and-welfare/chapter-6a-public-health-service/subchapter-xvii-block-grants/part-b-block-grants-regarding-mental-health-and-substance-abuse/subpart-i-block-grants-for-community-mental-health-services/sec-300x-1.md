...
The Secretary shall establish standardized methods for making the estimates required in subsection (b)(11) <sup><a href="#300x-1_1_target" name="300x-1_1">1</a></sup> with respect to a State. A funding agreement for a grant under section 300x of this title for the State is that the State will utilize such methods in making the estimates.
