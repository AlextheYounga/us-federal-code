...
The guidelines issued by the Secretary under subparagraph (A) shall be appropriate and uniform for measures funded with each type of funding made available under paragraph (10), but may distinguish between different types of measures <sup><a href="#8253_1_target" name="8253_1">1</a></sup> project size, and other criteria the Secretary determines are relevant.
...
[<sup>1</sup> So in original. A comma probably should appear.](#8253_1)