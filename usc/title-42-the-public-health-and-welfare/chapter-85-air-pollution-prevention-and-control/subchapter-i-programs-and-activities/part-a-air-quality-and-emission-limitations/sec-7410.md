...
Except for a primary nonferrous smelter order under section 7419 of this title, a suspension under subsection (f) or (g) (relating to emergency suspensions), an exemption under section 7418 of this title (relating to certain Federal facilities), an order under section 7413(d) <sup><a href="#7410_2_target" name="7410_2">2</a></sup> of this title (relating to compliance orders), a plan promulgation under subsection (c), or a plan revision under subsection (a)(3); no order, suspension, plan revision, or other action modifying any requirement of an applicable implementation plan may be taken with respect to any stationary source by the State or by the Administrator.
