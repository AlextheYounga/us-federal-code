...
(2)(A) An order issued under this section to a primary nonferrous smelter shall be referred to as a "primary nonferrous smelter order". No primary nonferrous smelter may receive both an enforcement order under section 7413(d) <sup><a href="#7419_1_target" name="7419_1">1</a></sup> of this title and a primary nonferrous smelter order under this section.
...
If the Administrator determines that a smelter to which an order is issued under this section is in violation of any requirement of subsection (c) or (d), he shall—
...
[<sup>1</sup> See References in Text note below.](#7419_1)