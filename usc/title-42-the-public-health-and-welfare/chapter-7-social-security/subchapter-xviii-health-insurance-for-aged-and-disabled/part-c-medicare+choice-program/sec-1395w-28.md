...
Subsec. (f)(5). Pub. L. 115–123, §50311(c)(1), designated existing provisions as subpar. (A), inserted heading, substituted "Subject to subparagraph (B), the requirements" for "The requirements", redesignated former pars. (A) and (B)(i) to (iii) as cls. (i) and (ii)(I) to (III), respectively, and added subpar. (B).
