...
In addition to the amount made available under paragraph (1), there shall be available to the Fund, for expenditures from the Fund in accordance with subparagraph (B), for fiscal year 2028 and thereafter, $5,796,117,810, to remain available until expended.
