...
In addition to the amount made available under paragraph (1), there shall be available to the Fund, for expenditures from the Fund in accordance with subparagraph (B), for fiscal year 2025 and thereafter, $3,464,000,000, to remain available until expended.
