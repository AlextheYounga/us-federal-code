...
and includes an outpatient health program or facility operated by a tribe or tribal organization under the Indian Self-Determination Act (Public Law 93–638) [25 U.S.C. 450f et seq.] or by an urban Indian organization receiving funds under title V of the Indian Health Care Improvement Act [25 U.S.C. 1651 et seq.] for the provision of primary health services. In applying clause (ii),<sup><a href="#1396d_3_target" name="1396d_3">3</a></sup> the Secretary may waive any requirement referred to in such clause for up to 2 years for good cause shown.
