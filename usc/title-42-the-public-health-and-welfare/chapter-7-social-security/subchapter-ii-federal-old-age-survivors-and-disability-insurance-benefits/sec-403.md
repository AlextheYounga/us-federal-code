...
If more than one of the events specified in subsections (c) and (d) and section 422(b) <sup><a href="#403_1_target" name="403_1">1</a></sup> of this title occurs in any one month which would occasion deductions equal to a benefit for such month, only an amount equal to such benefit shall be deducted.
