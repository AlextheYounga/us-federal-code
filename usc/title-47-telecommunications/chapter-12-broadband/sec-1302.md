...
As part of the inquiry required by subsection (b), the Commission shall compile a list of geographical areas that are not served by any provider of advanced telecommunications capability (as defined by subsection (d)(1)) <sup><a href="#1302_1_target" name="1302_1">1</a></sup> and to the extent that data from the Census Bureau is available, determine, for each such unserved area—
...
For purposes of this subsection: <sup><a href="#1302_2_target" name="1302_2">2</a></sup>
...
[<sup>1</sup> See References in Text note below.](#1302_1)

[<sup>2</sup> So in original. Probably should be "section:".](#1302_2)