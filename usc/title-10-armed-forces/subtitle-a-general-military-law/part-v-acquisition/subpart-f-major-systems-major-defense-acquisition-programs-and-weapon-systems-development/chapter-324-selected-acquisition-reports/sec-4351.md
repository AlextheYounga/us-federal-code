...
(iv) the primary risk parameters associated with the current procurement cost for the program (as that term is used in section 4355(4) <sup><a href="#4351_1_target" name="4351_1">1</a></sup> of this title);
...
[<sup>1</sup> See References in Text note below.](#4351_1)