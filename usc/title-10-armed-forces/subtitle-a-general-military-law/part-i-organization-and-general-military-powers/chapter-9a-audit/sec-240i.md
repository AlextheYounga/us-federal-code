...
(c) Unfunded Priority Defined.—In this section, the term "unfunded priority", with respect to a fiscal year, means an activity related to an audit readiness or remediation effort stemming from a relevant requirement under the Chief Financial Officer Act <sup><a href="#240i_1_target" name="240i_1">1</a></sup> (Public Law 101–576), chapter 9 of title 31, or this chapter that—
...
[<sup>1</sup> See References in Text note below.](#240i_1)