...
(B) eliminate <sup><a href="#2222_1_target" name="2222_1">1</a></sup> or reduce the need to tailor commercial off-the-shelf systems to meet or incorporate requirements or interfaces that are unique to the Department of Defense.
...
(E) is <sup><a href="#2222_2_target" name="2222_2">2</a></sup> in compliance with the Department's auditability requirements.
...
(5) Priority defense business system program <sup><a href="#2222_3_target" name="2222_3">3</a></sup>.—The term "priority defense business system" <sup><a href="#2222_3_target" name="2222_3">3</a></sup> means a defense business system that is—
...
[<sup>1</sup> So in original. Probably should be preceded by "to".](#2222_1)

[<sup>2</sup> So in original. Probably should be preceded by "the system".](#2222_2)

[<sup>3</sup> So in original. The heading does not match the defined term.](#2222_3)