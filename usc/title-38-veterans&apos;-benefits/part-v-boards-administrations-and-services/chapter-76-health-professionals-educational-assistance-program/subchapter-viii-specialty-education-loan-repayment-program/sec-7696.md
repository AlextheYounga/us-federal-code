...
(c) Penalty.—(1) An employee who does not complete a period of obligated service under this section shall owe the Federal Government an amount determined in accordance with the following formula: *A = B × ((T - S) ÷* T)).<sup><a href="#7696_1_target" name="7696_1">1</a></sup>
...
[<sup>1</sup> So in original. There is an extra closing parenthesis in the formula.](#7696_1)