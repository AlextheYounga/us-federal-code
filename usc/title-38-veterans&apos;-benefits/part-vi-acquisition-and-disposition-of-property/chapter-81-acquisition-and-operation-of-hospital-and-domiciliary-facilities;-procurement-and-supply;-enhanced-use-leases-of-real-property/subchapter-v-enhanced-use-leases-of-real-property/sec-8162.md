...
(2) The Secretary may enter into an enhanced-use lease only for the provision of supportive housing and the <sup><a href="#8162_1_target" name="8162_1">1</a></sup> lease is not inconsistent with and will not adversely affect the mission of the Department.
...
[<sup>1</sup> So in original. Probably should be preceded by "only if".](#8162_1)