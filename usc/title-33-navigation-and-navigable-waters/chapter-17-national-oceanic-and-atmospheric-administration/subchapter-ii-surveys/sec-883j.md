...
The Administrator of the National Oceanic and Atmospheric Administration (hereinafter referred to in this subtitle <sup><a href="#883j_1_target" name="883j_1">1</a></sup> as the "Administration") shall take such actions, including the sponsorship of applied research, as may be necessary to assure the future availability and usefulness of ocean satellite data to the maritime community.
...
[<sup>1</sup> See References in Text note below.](#883j_1)