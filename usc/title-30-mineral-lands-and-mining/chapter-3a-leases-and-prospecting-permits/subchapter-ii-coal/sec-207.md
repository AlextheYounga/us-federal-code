...
(6) <sup><a href="#207_1_target" name="207_1">1</a></sup> The amount of any production royalty paid for any year shall be reduced (but not below 0) by the amount of any advance royalties paid under a lease described in paragraph (5) to the extent that the advance royalties have not been used to reduce production royalties for a prior year.

(6) <sup><a href="#207_1_target" name="207_1">1</a></sup> The Secretary may, upon six months' notification to the lessee cease to accept advance royalties in lieu of the requirement of continued operation.
...
[<sup>1</sup> So in original. Two pars. (6) have been enacted.](#207_1)