...
Section 202 of the North American Free Trade Agreement Implementation Act (19 U.S.C. 3332),<sup><a href="#4531_1_target" name="4531_1">1</a></sup> as in effect on the day before the date on which the USMCA enters into force, shall continue to apply on and after that date with respect to a good entered for consumption, or withdrawn from warehouse for consumption, before that date.
...
[<sup>1</sup> See References in Text note below.](#4531_1)