...
(iv) <sup><a href="#3804_1_target" name="3804_1">1</a></sup> Resolutions in the Senate—
...
(iv) <sup><a href="#3804_1_target" name="3804_1">1</a></sup> It is not in order for the House of Representatives to consider any resolution that is not reported by the Committee on Ways and Means and, in addition, by the Committee on Rules.
...
[<sup>1</sup> So in original. Two cls. (iv) have been enacted.](#3804_1)