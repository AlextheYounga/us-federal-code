...
[<sup>1</sup> So in original. First word only of item should be capitalized.](#PARTII_1)

[<sup>2</sup> So in original. Does not conform to chapter heading and first word only of item should be capitalized.](#PARTII_2)