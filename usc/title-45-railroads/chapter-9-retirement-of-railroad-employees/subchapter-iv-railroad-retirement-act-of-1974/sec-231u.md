...
(A) the first fiscal year during which benefits under this subchapter must be reduced, in the absence of any adjustments, because insufficient funds (including any general revenue borrowing authority under this subchapter) would preclude payment of full benefits (other than benfits <sup><a href="#231u_1_target" name="231u_1">1</a></sup> payable from the Dual Benefits Payments Account) for every month in such fiscal year;
...
[<sup>1</sup> So in original. Probably should be "benefits".](#231u_1)