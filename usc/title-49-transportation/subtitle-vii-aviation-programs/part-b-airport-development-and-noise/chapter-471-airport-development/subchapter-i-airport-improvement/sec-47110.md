...
(B) if the cost is incurred after June 1, 1989, by the airport operator (regardless of when the grant agreement is executed) as part of a Government-approved noise compatability <sup><a href="#47110_1_target" name="47110_1">1</a></sup> program (including project formulation costs) and is consistent with all applicable statutory and administrative requirements;
...
[<sup>1</sup> So in original. Probably should be “compatibility”.](#47110_1)