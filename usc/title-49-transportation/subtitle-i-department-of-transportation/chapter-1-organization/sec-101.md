...
"(5) Explosive detection canine team.—The term 'explosives detection canine team' means a canine and a canine handler that are trained to detect explosives and other threats as defined by the Secretary.
