...
(iv) in which the borrower is receiving treatment for cancer and the 6 months after such period.<sup><a href="#1077_1_target" name="1077_1">1</a></sup>
...
(G)(i) contains a notice of the system,<sup><a href="#1077_2_target" name="1077_2">2</a></sup> of disclosure of information concerning such loan to consumer reporting agencies under section 1080a of this title, and (ii) provides that the lender on request of the borrower will provide information on the repayment status of the note to such consumer reporting agencies;
...
[<sup>1</sup> So in original. The period probably should be a semicolon.](#1077_1)

[<sup>2</sup> So in original. The comma probably should not appear.](#1077_2)