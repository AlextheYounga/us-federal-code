...
“(B) Ratable reductions.—If the sum appropriated under the authority of section 9123 of this title and not reserved under subsection (a) of this section for any fiscal year is insufficient to fully satisfy the aggregate of the minimum allotments for all States for that purpose for such year, each of such minimum allotments shall be reduced ratably.
