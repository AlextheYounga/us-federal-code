...
Funds made available under this subsection shall be used to supplement, and not supplant, State and local public funds expended to provide per pupil <sup><a href="#7221d_1_target" name="7221d_1">1</a></sup> facilities aid programs, operations financing programs, or other programs, for charter schools.
...
[<sup>1</sup> So in original. Probably should be "per-pupil".](#7221d_1)