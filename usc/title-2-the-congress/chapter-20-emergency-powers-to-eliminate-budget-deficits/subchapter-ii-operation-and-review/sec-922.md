...
(A) does not reduce automatic spending increases under any program specified in section 906(a) <sup><a href="#922_1_target" name="922_1">1</a></sup> of this title if such increases are required to be reduced by subchapter I of this chapter (or reduces such increases by a greater extent than is so required), or
...
[<sup>1</sup> See References in Text note below.](#922_1)