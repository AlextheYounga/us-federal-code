...
(B) may be exercised only during the fiscal year <sup><a href="#2796_1_target" name="2796_1">1</a></sup> the current fiscal year and only with respect to one country, unless the Congress hereafter provides otherwise.
...
[<sup>1</sup> So in original. The words “the fiscal year” probably should not appear.](#2796_1)