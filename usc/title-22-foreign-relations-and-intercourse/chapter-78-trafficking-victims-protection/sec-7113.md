...
In this paragraph, the term “unresolved audit finding” means an audit report finding in the final audit report of the Inspector General of the Department of Justice that the grantee has used grant funds for an unauthorized expenditure or otherwise unallowable cost that is not closed or resolved during the 12-month period beginning on the date on which the final audit report is issued <sup><a href="#7113_1_target" name="7113_1">1</a></sup>
...
[<sup>1</sup> So in original. Probably should be followed by a period.](#7113_1)