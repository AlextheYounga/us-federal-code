...
Not later than 1 year after May 29, 2015, and each year thereafter until the date described in subsection (h),<sup><a href="#7103b_1_target" name="7103b_1">1</a></sup> the Council shall submit a report that contains the findings derived from the reviews conducted pursuant to subsection (d)(2) to—
...
[<sup>1</sup> See References in Text note below.](#7103b_1)