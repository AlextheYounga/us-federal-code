...
(B) submit to Congress a report on the study conducted under subparagraph (A) that includes an assessment of whether the Bureau has provided the information required under subparagraph (B)(ix) <sup><a href="#10285_1_target" name="10285_1">1</a></sup> of paragraph (2) of this subsection in each report required under that paragraph.
...
[<sup>1</sup> So in original. Probably means subpar. (I) of par. (2).](#10285_1)