...
(3) Carrying out subsections (b), (c), and <sup><a href="#100507_1_target" name="100507_1">1</a></sup> (g).—To carry out subsections (b), (c), and (g), there is authorized to be appropriated $2,000,000 for each fiscal year.
...
[<sup>1</sup> So in original. Probably should be "and".](#100507_1)